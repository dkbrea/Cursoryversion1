...
import { PanelLeft, Landmark, ChevronRight, ChevronDown } from "lucide-react"
...
function SidebarAccountBalances() {
  ...
  return (
    <div className="px-4 py-3">
      <div className="mb-2 text-xs font-semibold tracking-wide text-purple-300 uppercase">Account Balances</div>
      {/* Checking Section */}
      <div className="mb-3">
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="font-bold text-sm text-sidebar-foreground">${checkingTotal.toLocaleString(undefined, { minimumFractionDigits: 2 })}</span>
        </div>
        {loading ? (
      ...
      <div>
        <button
          className="flex items-center justify-between w-full text-xs font-medium text-muted-foreground mb-1 focus:outline-none"
        ...
        >
          ...
          <span className="font-bold text-sm text-sidebar-foreground flex items-center gap-1">
            ${savingsTotal.toLocaleString(undefined, { minimumFractionDigits: 2 })}
            {showSavings ? <ChevronDown className="w-4 h-4 ml-1" /> : <ChevronRight className="w-4 h-4 ml-1" />}
          </span>
        </button>
        {showSavings && !loading && (
